...
SPLITTING_SEED = 1992  #seed for drawing examples at random for each set
...
if BUILD_BATCHES:
	...
	#build sets
	graph_ids_training = list()#determine execution mode
if BUILD_BATCHES:
...
for i in range(EPOCHS):
	...
	print("Setting Gumbel Softmax Temperature to "+str(gumbel_softmax_temperatures[i]))
